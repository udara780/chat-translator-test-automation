...
|  **Typing delay simulation** | Simulates realistic human typing speed to avoid triggering bot-detection |
...
|  **Headless / headed mode** | Run silently in CI or watch every action live in the browser |
|  **Keep-open mode** | Leaves the browser open after all tests for manual inspection |
|  **Overlay dismissal** | Auto-closes cookie consent and GDPR overlays before interacting |
